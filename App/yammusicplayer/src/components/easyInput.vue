<template>
  ...
  >
    ...
    >
      ...
      <!--只有这里的filter: drop-shadow(#c0c4cc 1000px 0)改变颜色-->
      <image
        v-if="prefixIcon"
        class="content-clear-icon"
        :src="prefixIcon"
        style="width:32upx;height:32upx;"
        mode="scaleToFill"
      />
      <slot name="left">
      </slot>
      ...
      <template v-if="type === 'password' && passwordIcon">
        ...
        <image
          v-if="isVal"
          :src="showPassword?'/static/eye-slash-fill.svg':'/static/eye-fill.svg'"
          class="content-clear-icon"
          :class="{ 'is-textarea-icon': type === 'textarea' }"
          mode="scaleToFill"
          :style="{width:'22upx',height:'22upx',color:focusShow ? primaryColor : '#c0c4cc'}"
          @click="onEyes"
        />
      </template>
      <template v-if="suffixIcon">
        ...
        <image
          ...
          class="content-clear-icon"
          :src="suffixIcon"
          style="width: 22upx;height:22upx;color:#c0c4cc;"
          @click="onClickIcon('suffix')"
          mode="scaleToFill"
        />
      </template>
      <template v-else>
        ...
        <image
          ...
          class="content-clear-icon"
          :class="{ 'is-textarea-icon': type === 'textarea' }"
          :style="{width:`${clearSize}upx`,color:msg ? '#dd524d' : focusShow ? primaryColor : '#c0c4cc'}"
          @click="onClear"
          mode="scaleToFill"
        />
      </template>
